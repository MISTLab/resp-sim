...
bool arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::isLittleEndian() const throw(){
    return true;
}
...
void arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::waitInstrEnd() const throw(){
    if(this->instrExecuting){
        wait(this->instrEndEvent);
    }
}

bool arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::isRoutineEntry( const InstructionBase \
    * instr ) throw(){
...
bool arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::isRoutineExit( const InstructionBase * \
    instr ) throw(){
...
unsigned char * arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::getState() const throw(){
...
unsigned int arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::getCodeLimit(){
    return this->PROGRAM_LIMIT;
}

unsigned int arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::readLR() const throw(){
    return this->LINKR;
}

void arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::setLR( const unsigned int & newValue ) \
    throw(){
    this->LINKR.immediateWrite(newValue);
}

unsigned int arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::readPC() const throw(){
    return this->PC + -4;
}

void arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::setPC( const unsigned int & newValue ) \
    throw(){
    this->PC.immediateWrite(newValue);
}

unsigned int arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::readSP() const throw(){
    return this->SPTR;
}

void arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::setSP( const unsigned int & newValue ) \
    throw(){
    this->SPTR.immediateWrite(newValue);
}

unsigned int arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::readFP() const throw(){
    return this->FP;
}

void arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::setFP( const unsigned int & newValue ) \
    throw(){
    this->FP.immediateWrite(newValue);
}

unsigned int arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::readRetVal() const throw(){
    return this->REGS[0];
}

void arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::setRetVal( const unsigned int & newValue \
    ) throw(){
    this->REGS[0].immediateWrite(newValue);
}

std::vector< unsigned int > arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::readArgs() const \
    throw(){
...
void arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::setArgs( const std::vector< unsigned int \
    > & args ) throw(){
    if(args.size() > 4){
...
unsigned int arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::readGDBReg( const unsigned int \
    & gdbId ) const throw(){
    switch(gdbId){
        case 0:{
            return REGS[0];
...
unsigned int arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::nGDBRegs() const throw(){
    return 17;
}

void arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::setGDBReg( const unsigned int & newValue, \
...
unsigned int arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::readMem( const unsigned int & \
    address ){
    return this->dataMem.read_word_dbg(address);
}

unsigned char arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::readCharMem( const unsigned int \
    & address ){
    return this->dataMem.read_byte_dbg(address);
}

void arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::writeMem( const unsigned int & address, \
    unsigned int datum ){
    this->dataMem.write_word_dbg(address, datum);
}

void arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::writeCharMem( const unsigned int & address, \
    unsigned char datum ){
    this->dataMem.write_byte_dbg(address, datum);
}

boost::circular_buffer< HistoryInstrType > & arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::getInstructionHistory(){
    return this->instHistoryQueue;
}

arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::~ARM9TDMI_ABIIf(){

}
arm9tdmi_funclt_trap::ARM9TDMI_ABIIf::ARM9TDMI_ABIIf( unsigned int & PROGRAM_LIMIT, \
    ...
    * SPSR, Alias & FP, Alias & SPTR, Alias & LINKR, Alias & SP_SVC, Alias & LR_SVC, \
    ...
    & LR_FIQ, Alias & PC, Alias * REGS, bool & instrExecuting, sc_event & instrEndEvent, \
    boost::circular_buffer< HistoryInstrType > & instHistoryQueue ) : PROGRAM_LIMIT(PROGRAM_LIMIT), \
    dataMem(dataMem), CPSR(CPSR), MP_ID(MP_ID), RB(RB), SPSR(SPSR), FP(FP), SPTR(SPTR), \
    LINKR(LINKR), SP_SVC(SP_SVC), LR_SVC(LR_SVC), SP_ABT(SP_ABT), LR_ABT(LR_ABT), SP_IRQ(SP_IRQ), \
    LR_IRQ(LR_IRQ), SP_FIQ(SP_FIQ), LR_FIQ(LR_FIQ), PC(PC), REGS(REGS), instrExecuting(instrExecuting), \
    instrEndEvent(instrEndEvent), instHistoryQueue(instHistoryQueue){
    this->routineExitState = 0;
    this->routineEntryState = 0;
