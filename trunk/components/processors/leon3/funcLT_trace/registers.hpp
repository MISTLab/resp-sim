...
namespace leon3_trace_trap{
    ...
    class Register : public sc_module{
        ...
        Register( const sc_module_name & name, unsigned int bitWidth );
...
namespace leon3_trace_trap{
    ...
    class Reg32_0_delay_3 : public Register{
        ...
        class InnerField_VER : public InnerField{
            ...
            public:
            InnerField_VER( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_ICC_z : public InnerField{
            ...
            public:
            InnerField_ICC_z( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_ICC_v : public InnerField{
            ...
            public:
            InnerField_ICC_v( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_EF : public InnerField{
            ...
            public:
            InnerField_EF( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_EC : public InnerField{
            ...
            public:
            InnerField_EC( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_ICC_n : public InnerField{
            ...
            public:
            InnerField_ICC_n( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_S : public InnerField{
            ...
            public:
            InnerField_S( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_ET : public InnerField{
            ...
            public:
            InnerField_ET( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_PIL : public InnerField{
            ...
            public:
            InnerField_PIL( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_IMPL : public InnerField{
            ...
            public:
            InnerField_IMPL( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        Reg32_0_delay_3 & operator <<=( const unsigned int & other ) throw();
        Reg32_0_delay_3 & operator >>=( const unsigned int & other ) throw();
        unsigned int operator +( const Reg32_0_delay_3 & other ) const throw();
        unsigned int operator -( const Reg32_0_delay_3 & other ) const throw();
        unsigned int operator *( const Reg32_0_delay_3 & other ) const throw();
        unsigned int operator /( const Reg32_0_delay_3 & other ) const throw();
        unsigned int operator |( const Reg32_0_delay_3 & other ) const throw();
        ...
        unsigned int operator <<( const Reg32_0_delay_3 & other ) const throw();
        unsigned int operator >>( const Reg32_0_delay_3 & other ) const throw();
        bool operator <( const Reg32_0_delay_3 & other ) const throw();
        bool operator >( const Reg32_0_delay_3 & other ) const throw();
        bool operator <=( const Reg32_0_delay_3 & other ) const throw();
        bool operator >=( const Reg32_0_delay_3 & other ) const throw();
        bool operator ==( const Reg32_0_delay_3 & other ) const throw();
        bool operator !=( const Reg32_0_delay_3 & other ) const throw();
        Reg32_0_delay_3 & operator =( const Reg32_0_delay_3 & other ) throw();
        Reg32_0_delay_3 & operator +=( const Reg32_0_delay_3 & other ) throw();
        Reg32_0_delay_3 & operator -=( const Reg32_0_delay_3 & other ) throw();
        Reg32_0_delay_3 & operator *=( const Reg32_0_delay_3 & other ) throw();
        Reg32_0_delay_3 & operator /=( const Reg32_0_delay_3 & other ) throw();
        ...
        bool operator ==( const Register & other ) const throw();
        bool operator !=( const Register & other ) const throw();
        Reg32_0_delay_3 & operator =( const Register & other ) throw();
        Reg32_0_delay_3 & operator +=( const Register & other ) throw();
        Reg32_0_delay_3 & operator -=( const Register & other ) throw();
        Reg32_0_delay_3 & operator *=( const Register & other ) throw();
        Reg32_0_delay_3 & operator /=( const Register & other ) throw();
...
namespace leon3_trace_trap{
    ...
    class Reg32_1_delay_3 : public Register{
        ...
        class InnerField_WIM_28 : public InnerField{
            ...
            public:
            InnerField_WIM_28( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_29 : public InnerField{
            ...
            public:
            InnerField_WIM_29( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_24 : public InnerField{
            ...
            public:
            InnerField_WIM_24( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_25 : public InnerField{
            ...
            public:
            InnerField_WIM_25( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_26 : public InnerField{
            ...
            public:
            InnerField_WIM_26( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_27 : public InnerField{
            ...
            public:
            InnerField_WIM_27( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_20 : public InnerField{
            ...
            public:
            InnerField_WIM_20( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
                return (this->value & 0x100000) >> 20;
            }
        ...
        class InnerField_WIM_21 : public InnerField{
            ...
            public:
            InnerField_WIM_21( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
                return (this->value & 0x200000) >> 21;
            }
        ...
        class InnerField_WIM_22 : public InnerField{
            ...
            public:
            InnerField_WIM_22( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
                return (this->value & 0x400000) >> 22;
            }
        ...
        class InnerField_WIM_23 : public InnerField{
            ...
            public:
            InnerField_WIM_23( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
                return (this->value & 0x800000) >> 23;
            }
        ...
        class InnerField_WIM_9 : public InnerField{
            ...
            public:
            InnerField_WIM_9( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_8 : public InnerField{
            ...
            public:
            InnerField_WIM_8( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_1 : public InnerField{
            ...
            public:
            InnerField_WIM_1( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_0 : public InnerField{
            ...
            public:
            InnerField_WIM_0( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_3 : public InnerField{
            ...
            public:
            InnerField_WIM_3( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_2 : public InnerField{
            ...
            public:
            InnerField_WIM_2( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_5 : public InnerField{
            ...
            public:
            InnerField_WIM_5( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
                return (this->value & 0x20) >> 5;
            }
        ...
        class InnerField_WIM_4 : public InnerField{
            ...
            public:
            InnerField_WIM_4( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_7 : public InnerField{
            ...
            public:
            InnerField_WIM_7( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
                return (this->value & 0x80) >> 7;
            }
        ...
        class InnerField_WIM_6 : public InnerField{
            ...
            public:
            InnerField_WIM_6( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
                return (this->value & 0x40) >> 6;
            }
        ...
        class InnerField_WIM_11 : public InnerField{
            ...
            public:
            InnerField_WIM_11( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_10 : public InnerField{
            ...
            public:
            InnerField_WIM_10( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_13 : public InnerField{
            ...
            public:
            InnerField_WIM_13( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
                return (this->value & 0x2000) >> 13;
            }
        ...
        class InnerField_WIM_12 : public InnerField{
            ...
            public:
            InnerField_WIM_12( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
                return (this->value & 0x1000) >> 12;
            }
        ...
        class InnerField_WIM_15 : public InnerField{
            ...
            public:
            InnerField_WIM_15( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_14 : public InnerField{
            ...
            public:
            InnerField_WIM_14( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_17 : public InnerField{
            ...
            public:
            InnerField_WIM_17( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_16 : public InnerField{
            ...
            public:
            InnerField_WIM_16( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_19 : public InnerField{
            ...
            public:
            InnerField_WIM_19( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_18 : public InnerField{
            ...
            public:
            InnerField_WIM_18( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_31 : public InnerField{
            ...
            public:
            InnerField_WIM_31( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        class InnerField_WIM_30 : public InnerField{
            ...
            public:
            InnerField_WIM_30( unsigned int & value, unsigned int & valueLast, bool & lastValid );
            InnerField & operator =( const unsigned int & other ) throw();
            inline operator unsigned int() const throw(){
        ...
        public:
        Reg32_1_delay_3();
        Reg32_1_delay_3( sc_module_name name );
        inline InnerField & operator []( int bitField ) throw(){
            switch(bitField){
                case key_WIM_28:{
        ...
        unsigned int readNewValue() throw();
        unsigned int operator ~() throw();
        Reg32_1_delay_3 & operator =( const unsigned int & other ) throw();
        Reg32_1_delay_3 & operator +=( const unsigned int & other ) throw();
        Reg32_1_delay_3 & operator -=( const unsigned int & other ) throw();
        Reg32_1_delay_3 & operator *=( const unsigned int & other ) throw();
        Reg32_1_delay_3 & operator /=( const unsigned int & other ) throw();
        ...
        Reg32_1_delay_3 & operator <<=( const unsigned int & other ) throw();
        Reg32_1_delay_3 & operator >>=( const unsigned int & other ) throw();
        unsigned int operator +( const Reg32_1_delay_3 & other ) const throw();
        unsigned int operator -( const Reg32_1_delay_3 & other ) const throw();
        unsigned int operator *( const Reg32_1_delay_3 & other ) const throw();
        unsigned int operator /( const Reg32_1_delay_3 & other ) const throw();
        unsigned int operator |( const Reg32_1_delay_3 & other ) const throw();
        ...
        unsigned int operator <<( const Reg32_1_delay_3 & other ) const throw();
        unsigned int operator >>( const Reg32_1_delay_3 & other ) const throw();
        bool operator <( const Reg32_1_delay_3 & other ) const throw();
        bool operator >( const Reg32_1_delay_3 & other ) const throw();
        bool operator <=( const Reg32_1_delay_3 & other ) const throw();
        bool operator >=( const Reg32_1_delay_3 & other ) const throw();
        bool operator ==( const Reg32_1_delay_3 & other ) const throw();
        bool operator !=( const Reg32_1_delay_3 & other ) const throw();
        Reg32_1_delay_3 & operator =( const Reg32_1_delay_3 & other ) throw();
        Reg32_1_delay_3 & operator +=( const Reg32_1_delay_3 & other ) throw();
        Reg32_1_delay_3 & operator -=( const Reg32_1_delay_3 & other ) throw();
        Reg32_1_delay_3 & operator *=( const Reg32_1_delay_3 & other ) throw();
        Reg32_1_delay_3 & operator /=( const Reg32_1_delay_3 & other ) throw();
        ...
        bool operator ==( const Register & other ) const throw();
        bool operator !=( const Register & other ) const throw();
        Reg32_1_delay_3 & operator =( const Register & other ) throw();
        Reg32_1_delay_3 & operator +=( const Register & other ) throw();
        Reg32_1_delay_3 & operator -=( const Register & other ) throw();
        Reg32_1_delay_3 & operator *=( const Register & other ) throw();
        Reg32_1_delay_3 & operator /=( const Register & other ) throw();
...
namespace leon3_trace_trap{
    ...
    class Reg32_3_off_4 : public Register{
        ...
        public:
        Reg32_3_off_4();
        Reg32_3_off_4( sc_module_name name );
        inline InnerField & operator []( int bitField ) throw(){
            return this->field_empty;
        }
        void immediateWrite( const unsigned int & value ) throw();
        unsigned int readNewValue() throw();
        unsigned int operator ~() throw();
        Reg32_3_off_4 & operator =( const unsigned int & other ) throw();
        Reg32_3_off_4 & operator +=( const unsigned int & other ) throw();
        Reg32_3_off_4 & operator -=( const unsigned int & other ) throw();
        Reg32_3_off_4 & operator *=( const unsigned int & other ) throw();
        Reg32_3_off_4 & operator /=( const unsigned int & other ) throw();
        ...
        Reg32_3_off_4 & operator <<=( const unsigned int & other ) throw();
        Reg32_3_off_4 & operator >>=( const unsigned int & other ) throw();
        unsigned int operator +( const Reg32_3_off_4 & other ) const throw();
        unsigned int operator -( const Reg32_3_off_4 & other ) const throw();
        unsigned int operator *( const Reg32_3_off_4 & other ) const throw();
        unsigned int operator /( const Reg32_3_off_4 & other ) const throw();
        unsigned int operator |( const Reg32_3_off_4 & other ) const throw();
        ...
        unsigned int operator <<( const Reg32_3_off_4 & other ) const throw();
        unsigned int operator >>( const Reg32_3_off_4 & other ) const throw();
        bool operator <( const Reg32_3_off_4 & other ) const throw();
        bool operator >( const Reg32_3_off_4 & other ) const throw();
        bool operator <=( const Reg32_3_off_4 & other ) const throw();
        bool operator >=( const Reg32_3_off_4 & other ) const throw();
        bool operator ==( const Reg32_3_off_4 & other ) const throw();
        bool operator !=( const Reg32_3_off_4 & other ) const throw();
        Reg32_3_off_4 & operator =( const Reg32_3_off_4 & other ) throw();
        Reg32_3_off_4 & operator +=( const Reg32_3_off_4 & other ) throw();
        Reg32_3_off_4 & operator -=( const Reg32_3_off_4 & other ) throw();
        Reg32_3_off_4 & operator *=( const Reg32_3_off_4 & other ) throw();
        Reg32_3_off_4 & operator /=( const Reg32_3_off_4 & other ) throw();
        ...
        bool operator ==( const Register & other ) const throw();
        bool operator !=( const Register & other ) const throw();
        Reg32_3_off_4 & operator =( const Register & other ) throw();
        Reg32_3_off_4 & operator +=( const Register & other ) throw();
        Reg32_3_off_4 & operator -=( const Register & other ) throw();
        Reg32_3_off_4 & operator *=( const Register & other ) throw();
        Reg32_3_off_4 & operator /=( const Register & other ) throw();
...
namespace leon3_trace_trap{
    ...
    class Reg32_3_const_0 : public Register{
        ...
        public:
        Reg32_3_const_0();
        Reg32_3_const_0( sc_module_name name );
        inline InnerField & operator []( int bitField ) throw(){
            return this->field_empty;
        }
        void immediateWrite( const unsigned int & value ) throw();
...
namespace leon3_trace_trap{
    ...
    class Reg32_3_delay_3 : public Register{
        ...
        public:
        Reg32_3_delay_3();
        Reg32_3_delay_3( sc_module_name name );
        inline InnerField & operator []( int bitField ) throw(){
            return this->field_empty;
        }
        inline void clockCycle() throw(){
        ...
        unsigned int readNewValue() throw();
        unsigned int operator ~() throw();
        Reg32_3_delay_3 & operator =( const unsigned int & other ) throw();
        Reg32_3_delay_3 & operator +=( const unsigned int & other ) throw();
        Reg32_3_delay_3 & operator -=( const unsigned int & other ) throw();
        Reg32_3_delay_3 & operator *=( const unsigned int & other ) throw();
        Reg32_3_delay_3 & operator /=( const unsigned int & other ) throw();
        ...
        Reg32_3_delay_3 & operator <<=( const unsigned int & other ) throw();
        Reg32_3_delay_3 & operator >>=( const unsigned int & other ) throw();
        unsigned int operator +( const Reg32_3_delay_3 & other ) const throw();
        unsigned int operator -( const Reg32_3_delay_3 & other ) const throw();
        unsigned int operator *( const Reg32_3_delay_3 & other ) const throw();
        unsigned int operator /( const Reg32_3_delay_3 & other ) const throw();
        unsigned int operator |( const Reg32_3_delay_3 & other ) const throw();
        ...
        unsigned int operator <<( const Reg32_3_delay_3 & other ) const throw();
        unsigned int operator >>( const Reg32_3_delay_3 & other ) const throw();
        bool operator <( const Reg32_3_delay_3 & other ) const throw();
        bool operator >( const Reg32_3_delay_3 & other ) const throw();
        bool operator <=( const Reg32_3_delay_3 & other ) const throw();
        bool operator >=( const Reg32_3_delay_3 & other ) const throw();
        bool operator ==( const Reg32_3_delay_3 & other ) const throw();
        bool operator !=( const Reg32_3_delay_3 & other ) const throw();
        Reg32_3_delay_3 & operator =( const Reg32_3_delay_3 & other ) throw();
        Reg32_3_delay_3 & operator +=( const Reg32_3_delay_3 & other ) throw();
        Reg32_3_delay_3 & operator -=( const Reg32_3_delay_3 & other ) throw();
        Reg32_3_delay_3 & operator *=( const Reg32_3_delay_3 & other ) throw();
        Reg32_3_delay_3 & operator /=( const Reg32_3_delay_3 & other ) throw();
        ...
        bool operator ==( const Register & other ) const throw();
        bool operator !=( const Register & other ) const throw();
        Reg32_3_delay_3 & operator =( const Register & other ) throw();
        Reg32_3_delay_3 & operator +=( const Register & other ) throw();
        Reg32_3_delay_3 & operator -=( const Register & other ) throw();
        Reg32_3_delay_3 & operator *=( const Register & other ) throw();
        Reg32_3_delay_3 & operator /=( const Register & other ) throw();
