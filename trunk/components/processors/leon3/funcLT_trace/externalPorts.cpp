...
void leon3_trace_trap::TLMMemory::setDebugger( MemoryToolsIf< unsigned int > * debugger \
    ){
    this->debugger = debugger;
}

sc_dt::uint64 leon3_trace_trap::TLMMemory::read_dword( const unsigned int & address \
    ) throw(){
...
unsigned short int leon3_trace_trap::TLMMemory::read_half( const unsigned int & address \
    ) throw(){
...
unsigned char leon3_trace_trap::TLMMemory::read_byte( const unsigned int & address \
    ) throw(){
...
void leon3_trace_trap::TLMMemory::write_dword( const unsigned int & address, sc_dt::uint64 \
    datum ) throw(){
    #ifdef LITTLE_ENDIAN_BO
    unsigned int datum1 = (unsigned int)(datum);
    this->swapEndianess(datum1);
...
void leon3_trace_trap::TLMMemory::write_half( const unsigned int & address, unsigned \
...
void leon3_trace_trap::TLMMemory::write_byte( const unsigned int & address, unsigned \
    char datum ) throw(){
    if(this->debugger != NULL){
        this->debugger->notifyAddress(address, sizeof(datum));
    }
...
sc_dt::uint64 leon3_trace_trap::TLMMemory::read_dword_dbg( const unsigned int & address \
    ) throw(){
    tlm::tlm_generic_payload trans;
    trans.set_address(address);
    trans.set_read();
...
unsigned int leon3_trace_trap::TLMMemory::read_word_dbg( const unsigned int & address \
    ) throw(){
    tlm::tlm_generic_payload trans;
    trans.set_address(address);
    trans.set_read();
...
unsigned short int leon3_trace_trap::TLMMemory::read_half_dbg( const unsigned int \
    & address ) throw(){
    tlm::tlm_generic_payload trans;
    trans.set_address(address);
    trans.set_read();
...
unsigned char leon3_trace_trap::TLMMemory::read_byte_dbg( const unsigned int & address \
    ) throw(){
    tlm::tlm_generic_payload trans;
    trans.set_address(address);
    trans.set_read();
...
void leon3_trace_trap::TLMMemory::write_dword_dbg( const unsigned int & address, \
...
void leon3_trace_trap::TLMMemory::write_word_dbg( const unsigned int & address, unsigned \
    int datum ) throw(){
    //Now the code for endianess conversion: the processor is always modeled
    //with the host endianess; in case they are different, the endianess
    //is turned
...
void leon3_trace_trap::TLMMemory::write_half_dbg( const unsigned int & address, unsigned \
    short int datum ) throw(){
    //Now the code for endianess conversion: the processor is always modeled
    //with the host endianess; in case they are different, the endianess
    //is turned
...
void leon3_trace_trap::TLMMemory::write_byte_dbg( const unsigned int & address, unsigned \
    char datum ) throw(){
    tlm::tlm_generic_payload trans;
    trans.set_address(address);
    trans.set_write();
...
void leon3_trace_trap::TLMMemory::lock(){

}

void leon3_trace_trap::TLMMemory::unlock(){

}

leon3_trace_trap::TLMMemory::TLMMemory( sc_module_name portName, tlm_utils::tlm_quantumkeeper \
