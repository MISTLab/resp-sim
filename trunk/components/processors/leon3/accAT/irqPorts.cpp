...
void leon3_accat_trap::IntrTLMPort_32::b_transport( int tag, tlm::tlm_generic_payload \
    & trans, sc_time & delay ){
...
unsigned int leon3_accat_trap::IntrTLMPort_32::transport_dbg( int tag, tlm::tlm_generic_payload \
    & trans ){
    unsigned char* ptr = trans.get_data_ptr();
    sc_dt::uint64 adr = trans.get_address();
    if(*ptr == 0){
...
tlm::tlm_sync_enum leon3_accat_trap::IntrTLMPort_32::nb_transport_fw( int tag, tlm::tlm_generic_payload \
    & trans, tlm::tlm_phase & phase, sc_time & delay ){
    THROW_EXCEPTION("Method not yet implemented");
}

leon3_accat_trap::IntrTLMPort_32::IntrTLMPort_32( sc_module_name portName, unsigned \
