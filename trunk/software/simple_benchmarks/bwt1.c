...
***************************************************************************/
 /* Transform inFile */
int BWXformFile(const char *inFile, const char *outFile, char mtf);

/* Reverse Transform inFile*/
int BWReverseXformFile(const char *inFile, const char *outFile, char mtf);
...
int main(int argc, char *argv[])
{
    ...
    /* initialize data */
    const char *inFile = "software/benchmarks/data/input_very_very_small.asc";
