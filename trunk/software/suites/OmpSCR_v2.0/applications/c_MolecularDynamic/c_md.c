...
#define NUM_ARGS                2
#define NUM_TIMERS          1
#define DEFAULT_NPARTS  16
#define DEFAULT_NPARTS_STR "16"
#define DEFAULT_NSTEPS  8
#define DEFAULT_NSTEPS_STR  "8"
...
int main (int argc, char **argv) {
  ...
  char *DEFAULT_VALUES[NUM_ARGS] = {DEFAULT_NPARTS_STR, DEFAULT_NSTEPS_STR};
