...
for i in range(0, PROCESSOR_NUMBER):
    ...
    recEmu.registerCppCall('rgb2grey', scwrapper.sc_time(1000, scwrapper.SC_NS),10,10)
    recEmu.registerCppCall('edgeOverlapping', scwrapper.sc_time(1000, scwrapper.SC_NS),10,10)
    recEmu.registerCppCall('edgeDetectionSinglePixel', scwrapper.sc_time(10, scwrapper.SC_NS),10,10)
