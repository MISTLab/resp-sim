...
try:
    ...
    PROCESSOR_NAMESPACE = leon3_funcLT_wrapper.Processor_leon3_funclt
...
### IRQ Stuff
irqGen = irqGenerator_wrapper.IrqGenerator("irqGen", scwrapper.sc_time(1000, scwrapper.SC_US));
irqGen.initSocket.bind(processors[0].IRQ_port.socket);
processors[0].irqAck.initSocket.bind(irqGen.targSocket);
