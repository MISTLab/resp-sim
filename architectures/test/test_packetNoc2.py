...
m1.setParameters(SM_TRANSMISSIONS, 0x0, memorySize1+memorySize2*3-1, memorySize1/4, 8, addrSpace)
m2.setParameters(SM_TRANSMISSIONS, 0x0, memorySize1+memorySize2*3-1, memorySize1/8, 4, addrSpace)
m3.setParameters(SM_TRANSMISSIONS, 0x0, memorySize1+memorySize2*3-1, memorySize1/16, 8, addrSpace)
m4.setParameters(SM_TRANSMISSIONS, 0x400, memorySize1+memorySize2*3-1, memorySize1/16, 8, addrSpace)
m5.setParameters(SM_TRANSMISSIONS, 0x800, memorySize1+memorySize2*3-1, memorySize1/16, 4, addrSpace)
m6.setParameters(SM_TRANSMISSIONS, 0x0, memorySize1+memorySize2*3-1, memorySize1/8, 8, addrSpace)
