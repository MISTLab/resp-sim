...
# Matlab component
instSlave = MatlabSlave_img.MatlabSlave_img('matlab_img')
...
bus.addBinding("matlab_img.matlab_img_SimpleMatlabPort", WRITE_ADDR, WRITE_ADDR+SIZE)

# Application
software = '_build_/arm/software/application/testmatlab_img'
