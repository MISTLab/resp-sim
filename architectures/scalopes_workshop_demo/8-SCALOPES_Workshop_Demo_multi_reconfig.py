...
for i in range(0, PROCESSOR_NUMBER):
    ...
    recEmu.registerCppCall('edgeOverlapping', scwrapper.sc_time(1000, scwrapper.SC_NS),60,160)
    recEmu.registerCppCall('edgeDetectionSinglePixel', scwrapper.sc_time(10, scwrapper.SC_NS),50,50)
