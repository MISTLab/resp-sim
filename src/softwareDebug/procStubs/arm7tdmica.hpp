...
#ifndef ARM7TDMICA_HPP
#define ARM7TDMICA_HPP
...
class arm7caStub : public processorInterface<unsigned int>{
  private:
    arm7ca & processor;
    unsigned int verbosityLevel;
  public:
      arm7caStub(arm7ca & processor,  unsigned int verbosityLevel = 1);
      /**
