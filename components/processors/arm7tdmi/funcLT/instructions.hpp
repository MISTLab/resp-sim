...
namespace arm7tdmi_funclt_trap{
    ...
    class Instruction : public InstructionBase{
        ...
        Instruction( Reg32_0 & CPSR, Reg32_1 & MP_ID, Reg32_1 * RB, Reg32_0 * SPSR, Alias \
            & FP, Alias & SPTR, Alias & LINKR, Alias & SP_IRQ, Alias & LR_IRQ, Alias & SP_FIQ, \
...
namespace arm7tdmi_funclt_trap{
    ...
    class DPI_shift_imm_op : public virtual Instruction{
        ...
        DPI_shift_imm_op( Reg32_0 & CPSR, Reg32_1 & MP_ID, Reg32_1 * RB, Reg32_0 * SPSR, \
            Alias & FP, Alias & SPTR, Alias & LINKR, Alias & SP_IRQ, Alias & LR_IRQ, Alias & \
...
namespace arm7tdmi_funclt_trap{
    ...
    class TST_si : public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
        ...
        TST_si( Reg32_0 & CPSR, Reg32_1 & MP_ID, Reg32_1 * RB, Reg32_0 * SPSR, Alias & FP, \
            Alias & SPTR, Alias & LINKR, Alias & SP_IRQ, Alias & LR_IRQ, Alias & SP_FIQ, Alias \
...
namespace arm7tdmi_funclt_trap{
    ...
    class ADC_si : public UpdatePSRSumWithCarry_op, public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class SUB_sr : public UpdatePSRSub_op, public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class ADD_si : public UpdatePSRSum_op, public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class BIC_si : public UpdatePSRBit_op, public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class SBC_sr : public UpdatePSRSubWithCarry_op, public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class BRANCHX : public Instruction{
        private:
        Alias rm;
        unsigned int rm_bit;
        unsigned int cond;
...
namespace arm7tdmi_funclt_trap{
    ...
    class BIC_sr : public UpdatePSRBit_op, public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class ADD_sr : public UpdatePSRSum_op, public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class MOV_i : public UpdatePSRBit_op, public DPI_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class SWAPB : public Instruction{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class MVN_si : public UpdatePSRBit_op, public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class EOR_i : public UpdatePSRBit_op, public DPI_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class ADC_sr : public UpdatePSRSumWithCarry_op, public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class TST_sr : public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class ORR_i : public UpdatePSRBit_op, public DPI_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class LDR_imm : public LS_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class ORR_si : public UpdatePSRBit_op, public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class LDRB_imm : public LS_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class msr_reg_Instr : public Instruction{
        private:
        Alias rm;
        unsigned int rm_bit;
        unsigned int cond;
...
namespace arm7tdmi_funclt_trap{
    ...
    class ADD_i : public UpdatePSRSum_op, public DPI_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class AND_si : public UpdatePSRBit_op, public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class CMN_si : public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class LDM : public LSM_reglist_op{
        private:
        Alias rn;
        unsigned int rn_bit;
        unsigned int cond;
        ...
        LDM( Reg32_0 & CPSR, Reg32_1 & MP_ID, Reg32_1 * RB, Reg32_0 * SPSR, Alias & FP, Alias \
            & SPTR, Alias & LINKR, Alias & SP_IRQ, Alias & LR_IRQ, Alias & SP_FIQ, Alias & LR_FIQ, \
...
namespace arm7tdmi_funclt_trap{
    ...
    class LDRSH_off : public LS_sh_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class STR_imm : public LS_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class RSB_si : public UpdatePSRSub_op, public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class LDRSB_off : public LS_sh_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class SBC_i : public UpdatePSRSubWithCarry_op, public DPI_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class ADC_i : public UpdatePSRSumWithCarry_op, public DPI_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class LDRH_off : public LS_sh_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class STR_off : public LS_reg_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class STRH_off : public LS_sh_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class CMP_sr : public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class SUB_i : public UpdatePSRSub_op, public DPI_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class RSB_sr : public UpdatePSRSub_op, public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class AND_sr : public UpdatePSRBit_op, public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class RSC_si : public UpdatePSRSubWithCarry_op, public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class SBC_si : public UpdatePSRSubWithCarry_op, public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class MOV_si : public UpdatePSRBit_op, public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class umlal_Instr : public UpdatePSRmul_64_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class AND_i : public UpdatePSRBit_op, public DPI_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class LDR_off : public LS_reg_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class MOV_sr : public UpdatePSRBit_op, public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class RSC_sr : public UpdatePSRSubWithCarry_op, public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class BIC_i : public UpdatePSRBit_op, public DPI_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class TEQ_sr : public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class smull_Instr : public UpdatePSRmul_64_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class STRB_off : public LS_reg_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class smlal_Instr : public UpdatePSRmul_64_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class CMP_si : public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class TEQ_si : public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class CMN_sr : public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class mrs_Instr : public Instruction{
        private:
        Alias rd;
        unsigned int rd_bit;
        unsigned int cond;
...
namespace arm7tdmi_funclt_trap{
    ...
    class mul_Instr : public UpdatePSRmul_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class SUB_si : public UpdatePSRSub_op, public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class STM : public LSM_reglist_op{
        private:
        Alias rn;
        unsigned int rn_bit;
        unsigned int cond;
...
namespace arm7tdmi_funclt_trap{
    ...
    class ORR_sr : public UpdatePSRBit_op, public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class RSB_i : public UpdatePSRSub_op, public DPI_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class mla_Instr : public UpdatePSRmul_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class EOR_sr : public UpdatePSRBit_op, public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class msr_imm_Instr : public Instruction{
        private:
        unsigned int cond;
        unsigned int r;
        unsigned int mask;
...
namespace arm7tdmi_funclt_trap{
    ...
    class LDRB_off : public LS_reg_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class umull_Instr : public UpdatePSRmul_64_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class MVN_i : public UpdatePSRBit_op, public DPI_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class MVN_sr : public UpdatePSRBit_op, public DPI_reg_shift_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class EOR_si : public UpdatePSRBit_op, public DPI_shift_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rm;
...
namespace arm7tdmi_funclt_trap{
    ...
    class STRB_imm : public LS_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
...
namespace arm7tdmi_funclt_trap{
    ...
    class RSC_i : public UpdatePSRSubWithCarry_op, public DPI_imm_op{
        private:
        Alias rd;
        unsigned int rd_bit;
        Alias rn;
