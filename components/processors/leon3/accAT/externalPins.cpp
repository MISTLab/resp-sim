...
void leon3_accat_trap::PinTLM_out_32::send_pin_req( const unsigned int & address, \
...
leon3_accat_trap::PinTLM_out_32::PinTLM_out_32( sc_module_name portName ) : sc_module(portName), \
