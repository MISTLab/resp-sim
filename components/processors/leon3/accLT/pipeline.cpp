...
void leon3_acclt_trap::BasePipeStage::flush() throw(){
...
std::map< unsigned int, std::vector< Register * > > leon3_acclt_trap::BasePipeStage::unlockQueue;
leon3_acclt_trap::BasePipeStage::BasePipeStage( sc_time & latency, BasePipeStage \
...
void leon3_acclt_trap::FETCH_PipeStage::behavior(){
...
void leon3_acclt_trap::FETCH_PipeStage::waitPipeBegin() throw(){
...
void leon3_acclt_trap::FETCH_PipeStage::waitPipeEnd() throw(){
    this->stageBeginning = false;
...
void leon3_acclt_trap::FETCH_PipeStage::refreshRegisters() throw(){
...
void leon3_acclt_trap::DECODE_PipeStage::behavior(){
    this->curInstruction = this->NOPInstrInstance;
    this->nextInstruction = this->NOPInstrInstance;
...
void leon3_acclt_trap::DECODE_PipeStage::waitPipeBegin() throw(){
    this->stageBeginning = true;
    this->stageBeginningEv.notify();
...
void leon3_acclt_trap::DECODE_PipeStage::waitPipeEnd() throw(){
    this->stageBeginning = false;
    this->stageEnded = true;
    this->stageEndedEv.notify();
...
leon3_acclt_trap::DECODE_PipeStage::DECODE_PipeStage( sc_module_name pipeName, sc_time \
...
void leon3_acclt_trap::REGS_PipeStage::behavior(){
    this->curInstruction = this->NOPInstrInstance;
    this->nextInstruction = this->NOPInstrInstance;
    while(true){
        unsigned int numCycles = 0;
...
void leon3_acclt_trap::REGS_PipeStage::waitPipeBegin() throw(){
    this->stageBeginning = true;
    this->stageBeginningEv.notify();
    if(!this->stage_fetch->stageBeginning){
        wait(this->stage_fetch->stageBeginningEv);
...
void leon3_acclt_trap::REGS_PipeStage::waitPipeEnd() throw(){
    this->stageBeginning = false;
    this->stageEnded = true;
    this->stageEndedEv.notify();
    if(!this->stage_fetch->stageEnded){
...
leon3_acclt_trap::REGS_PipeStage::REGS_PipeStage( sc_module_name pipeName, sc_time \
    & latency, BasePipeStage * stage_fetch, BasePipeStage * stage_decode, BasePipeStage \
    * stage_regs, BasePipeStage * stage_execute, BasePipeStage * stage_memory, BasePipeStage \
    * stage_exception, BasePipeStage * stage_wb, BasePipeStage * prevStage, BasePipeStage \
    * succStage ) : sc_module(pipeName), BasePipeStage(latency, stage_fetch, stage_decode, \
...
void leon3_acclt_trap::EXECUTE_PipeStage::behavior(){
    this->curInstruction = this->NOPInstrInstance;
    this->nextInstruction = this->NOPInstrInstance;
    while(true){
        unsigned int numCycles = 0;
...
void leon3_acclt_trap::EXECUTE_PipeStage::waitPipeBegin() throw(){
    this->stageBeginning = true;
    this->stageBeginningEv.notify();
    if(!this->stage_fetch->stageBeginning){
        wait(this->stage_fetch->stageBeginningEv);
...
void leon3_acclt_trap::EXECUTE_PipeStage::waitPipeEnd() throw(){
    this->stageBeginning = false;
    this->stageEnded = true;
    this->stageEndedEv.notify();
    if(!this->stage_fetch->stageEnded){
...
leon3_acclt_trap::EXECUTE_PipeStage::EXECUTE_PipeStage( sc_module_name pipeName, \
...
void leon3_acclt_trap::MEMORY_PipeStage::behavior(){
    this->curInstruction = this->NOPInstrInstance;
    this->nextInstruction = this->NOPInstrInstance;
    while(true){
        unsigned int numCycles = 0;
...
void leon3_acclt_trap::MEMORY_PipeStage::waitPipeBegin() throw(){
    this->stageBeginning = true;
    this->stageBeginningEv.notify();
    if(!this->stage_fetch->stageBeginning){
        wait(this->stage_fetch->stageBeginningEv);
...
void leon3_acclt_trap::MEMORY_PipeStage::waitPipeEnd() throw(){
    this->stageBeginning = false;
    this->stageEnded = true;
    this->stageEndedEv.notify();
    if(!this->stage_fetch->stageEnded){
...
leon3_acclt_trap::MEMORY_PipeStage::MEMORY_PipeStage( sc_module_name pipeName, sc_time \
    & latency, BasePipeStage * stage_fetch, BasePipeStage * stage_decode, BasePipeStage \
    * stage_regs, BasePipeStage * stage_execute, BasePipeStage * stage_memory, BasePipeStage \
    * stage_exception, BasePipeStage * stage_wb, BasePipeStage * prevStage, BasePipeStage \
    * succStage ) : sc_module(pipeName), BasePipeStage(latency, stage_fetch, stage_decode, \
...
void leon3_acclt_trap::EXCEPTION_PipeStage::behavior(){
    this->curInstruction = this->NOPInstrInstance;
    this->nextInstruction = this->NOPInstrInstance;
    while(true){
        unsigned int numCycles = 0;
...
void leon3_acclt_trap::EXCEPTION_PipeStage::waitPipeBegin() throw(){
    this->stageBeginning = true;
    this->stageBeginningEv.notify();
    if(!this->stage_fetch->stageBeginning){
        wait(this->stage_fetch->stageBeginningEv);
...
void leon3_acclt_trap::EXCEPTION_PipeStage::waitPipeEnd() throw(){
    this->stageBeginning = false;
    this->stageEnded = true;
    this->stageEndedEv.notify();
    if(!this->stage_fetch->stageEnded){
...
leon3_acclt_trap::EXCEPTION_PipeStage::EXCEPTION_PipeStage( sc_module_name pipeName, \
    sc_time & latency, BasePipeStage * stage_fetch, BasePipeStage * stage_decode, BasePipeStage \
    * stage_regs, BasePipeStage * stage_execute, BasePipeStage * stage_memory, BasePipeStage \
    * stage_exception, BasePipeStage * stage_wb, BasePipeStage * prevStage, BasePipeStage \
    * succStage ) : sc_module(pipeName), BasePipeStage(latency, stage_fetch, stage_decode, \
...
void leon3_acclt_trap::WB_PipeStage::behavior(){
    this->curInstruction = this->NOPInstrInstance;
    this->nextInstruction = this->NOPInstrInstance;
    while(true){
        unsigned int numCycles = 0;
...
void leon3_acclt_trap::WB_PipeStage::waitPipeBegin() throw(){
    this->stageBeginning = true;
    this->stageBeginningEv.notify();
    if(!this->stage_fetch->stageBeginning){
        wait(this->stage_fetch->stageBeginningEv);
...
void leon3_acclt_trap::WB_PipeStage::waitPipeEnd() throw(){
    this->stageBeginning = false;
    this->stageEnded = true;
    this->stageEndedEv.notify();
    if(!this->stage_fetch->stageEnded){
...
leon3_acclt_trap::WB_PipeStage::WB_PipeStage( sc_module_name pipeName, sc_time & \
    latency, BasePipeStage * stage_fetch, BasePipeStage * stage_decode, BasePipeStage \
    * stage_regs, BasePipeStage * stage_execute, BasePipeStage * stage_memory, BasePipeStage \
    * stage_exception, BasePipeStage * stage_wb, BasePipeStage * prevStage, BasePipeStage \
    * succStage ) : sc_module(pipeName), BasePipeStage(latency, stage_fetch, stage_decode, \
