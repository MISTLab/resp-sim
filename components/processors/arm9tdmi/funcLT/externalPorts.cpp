...
void arm9tdmi_funclt_trap::TLMMemory::setDebugger( MemoryToolsIf< unsigned int > \
    * debugger ){
    this->debugger = debugger;
}

sc_dt::uint64 arm9tdmi_funclt_trap::TLMMemory::read_dword( const unsigned int & address \
    ) throw(){
...
unsigned short int arm9tdmi_funclt_trap::TLMMemory::read_half( const unsigned int \
    & address ) throw(){
    if(address == 0xfffffff0L){
        return this->MP_ID;
    }
...
unsigned char arm9tdmi_funclt_trap::TLMMemory::read_byte( const unsigned int & address \
    ) throw(){
    if(address == 0xfffffff0L){
        return this->MP_ID;
    }
...
void arm9tdmi_funclt_trap::TLMMemory::write_dword( const unsigned int & address, \
...
void arm9tdmi_funclt_trap::TLMMemory::write_half( const unsigned int & address, unsigned \
...
void arm9tdmi_funclt_trap::TLMMemory::write_byte( const unsigned int & address, unsigned \
    char datum ) throw(){
    if(address == 0xfffffff0L){
        this->MP_ID = datum;
        return;
...
sc_dt::uint64 arm9tdmi_funclt_trap::TLMMemory::read_dword_dbg( const unsigned int \
    & address ) throw(){
    if(address == 0xfffffff0L){
        return this->MP_ID;
    }
...
unsigned int arm9tdmi_funclt_trap::TLMMemory::read_word_dbg( const unsigned int & \
    address ) throw(){
    if(address == 0xfffffff0L){
        return this->MP_ID;
    }
...
unsigned short int arm9tdmi_funclt_trap::TLMMemory::read_half_dbg( const unsigned \
    int & address ) throw(){
    if(address == 0xfffffff0L){
        return this->MP_ID;
    }
...
unsigned char arm9tdmi_funclt_trap::TLMMemory::read_byte_dbg( const unsigned int \
    & address ) throw(){
    if(address == 0xfffffff0L){
        return this->MP_ID;
    }
...
void arm9tdmi_funclt_trap::TLMMemory::write_dword_dbg( const unsigned int & address, \
    sc_dt::uint64 datum ) throw(){
    #ifdef BIG_ENDIAN_BO
    unsigned int datum1 = (unsigned int)(datum);
    this->swapEndianess(datum1);
...
void arm9tdmi_funclt_trap::TLMMemory::write_word_dbg( const unsigned int & address, \
...
void arm9tdmi_funclt_trap::TLMMemory::write_half_dbg( const unsigned int & address, \
...
void arm9tdmi_funclt_trap::TLMMemory::write_byte_dbg( const unsigned int & address, \
...
void arm9tdmi_funclt_trap::TLMMemory::lock(){

}

void arm9tdmi_funclt_trap::TLMMemory::unlock(){

}

arm9tdmi_funclt_trap::TLMMemory::TLMMemory( sc_module_name portName, tlm_utils::tlm_quantumkeeper \
