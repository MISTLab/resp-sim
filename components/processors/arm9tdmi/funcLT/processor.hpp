...
namespace arm9tdmi_funclt_trap{
    ...
    class Processor_arm9tdmi_funclt : public sc_module{
        ...
        public:
        SC_HAS_PROCESS( Processor_arm9tdmi_funclt );
        Processor_arm9tdmi_funclt( sc_module_name name, sc_time latency );
        void mainLoop();
        void resetOp();
        void end_of_elaboration();
        Instruction * decode( unsigned int bitString );
        ARM9TDMI_ABIIf * abiIf;
        ARM9TDMI_ABIIf & getInterface();
