...
static void sha_transform(SHA_INFO *sha_info)
{
    ...
    /*for (i = 0; i < 16; ++i) {/ Performing Loop unfolding
	W[i] = sha_info->data[i];
    }*/
	W[0] = sha_info->data[0];
	W[1] = sha_info->data[1];
	...
	W[8] = sha_info->data[8];
	W[9] = sha_info->data[9];
	W[10] = sha_info->data[0];
	W[11] = sha_info->data[1];
	W[12] = sha_info->data[2];
	W[13] = sha_info->data[3];
	W[14] = sha_info->data[4];
	W[15] = sha_info->data[5];
    for (i = 16; i < 80; ++i) {
...
int main(int argc, char **argv)
{
    ...
    SHA_INFO sha_info;
	    ...
	    fin = fopen("software/benchmarks/data/sha_input_very_small.asc", "rb");
	    if (fin == NULL) {
