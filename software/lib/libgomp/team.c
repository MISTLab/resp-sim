...
gomp_thread_start (void *xdata)
{
  ...
  #ifdef DEBUG_GOMP
  fprintf(stderr, "gomp_thread_start: nested = %d\n", data->nested);
  #endif
  ...
  if (data->nested)
    {
      ...
      #ifdef DEBUG_GOMP
      fprintf(stderr, "ended waited on barrier: sem1 = %d, sem2 = %d, mutex1 = %d, mutex2 = %d\n", 
        thr->ts.team->barrier.sem1, thr->ts.team->barrier.sem2, thr->ts.team->barrier.mutex1, thr->ts.team->barrier.mutex2);
      #endif
  ...
  else
    {
      ...
      #ifdef DEBUG_GOMP
      fprintf(stderr, "ended waited on barrier in non nested: sem1 = %d, sem2 = %d, mutex1 = %d, mutex2 = %d\n", 
        gomp_threads_dock.sem1, gomp_threads_dock.sem2, gomp_threads_dock.mutex1, gomp_threads_dock.mutex2);
      #endif
      ...
      do
    {
      ...
      #ifdef DEBUG_GOMP
      fprintf(stderr, "Executed one function of thread\n");
      #endif
...
new_team (unsigned nthreads, struct gomp_work_share *work_share)
{
  ...
  size_t size;
      ...
      #ifdef DEBUG_GOMP
      fprintf(stderr, "New team of %d threads\n",nthreads);
      #endif
         ...
         struct gomp_work_share *work_share)
{
  ...
  unsigned i, n, old_threads_used = 0;
     ...
     #ifdef DEBUG_GOMP
      fprintf(stderr, "Starting team of %d threads\n", nthreads);
      #endif
